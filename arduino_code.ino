...
//sensor pins
#define S1 6 // pin 7 for Ir sensor
#define S2 5 // pin 6 for Ir sensor
#define S3 4 // pin 5 for Ir sensor
#define S4 3 // pin 4 for Ir sensor
...
void setup(){
  ...
  pinMode(S1, INPUT);//define front-left input pin
  pinMode(S2, INPUT);//define front-right input pin
  pinMode(S3, INPUT);//define rear-left input pin
  pinMode(S4, INPUT);//define rear-right input pin 
...
void loop(){
 ...
 int sens4 = digitalRead(S4);
  ...
  if (distance <= 50 ||sens1 == LOW || sens2 == LOW || sens3== LOW ||sens4 == LOW ){
    moveStop();
    delay(300);
    moveBackward();
    delay(600);
